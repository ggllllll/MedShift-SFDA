...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-file', type=str, default=r'')#D4/checkpoint_170.pth.tar
    parser.add_argument('--dataset', type=str, default='')#Domain1
    parser.add_argument('--source', type=str, default='')#Domain4
    ...
    #             }, './log/sim_learn_MESSIDOR_Base1.pth.tar')
    torch.save({
                'model_state_dict': model.state_dict(),
               }, r'')
