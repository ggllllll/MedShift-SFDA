...
class FundusSegmentation(Dataset):
    ...
    def __getitem__(self, index):
        _img = Image.open(os.path.join(self._base_dir, self.image_list[index]['image']))
        _target = Image.open(os.path.join(self._base_dir, self.image_list[index]['label']))
...
class FundusSegmentation_wsim(Dataset):
    ...
    def __getitem__(self, index):
        ...
        mask_0_obj[uncertain_map[0:1, ...] < 0.08] = 1.0
        mask_0_bck[uncertain_map[0:1, ...] < 0.08] = 1.0
